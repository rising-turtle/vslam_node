...
# ./run_vins-mono_ext.sh [bagfile] [times] 
#
...
result_dir="/home/davidz/work/ros/indigo/src/VINS-Mono_Ext"
...
do_it(){
    ...
    if [ ! -d "tum_vio_result/vins-mono_ext" ]; then
	mkdir -p "tum_vio_result/vins-mono_ext"
    fi
    cp "vins_result.csv" "tum_vio_result/vins-mono_ext/result_$i.csv"
