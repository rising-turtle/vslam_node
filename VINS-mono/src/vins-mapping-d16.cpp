...
void generatePC(CloudPtr& all_pc, vector<obsItem>& vobs)
{
  ...
  for(int i=0; i<vobs.size() && ros::ok(); i++)
  {
    ...
    *all_pc += *glo_pc; 
    ...
    // filterPointCloud<Point>(all_pc, filterPC, 0.1); 
...
{  
  ...
  // ds435 downsampled 
  double fx = 309.235; // 615.426; 
  double fy = 309.381; // 625.456; 
  double cx = 213.547; // 318.837;
  double cy = 118.772; // 240.594;
