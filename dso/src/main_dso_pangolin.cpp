...
std::string source = "/media/davidz/work/work/data/realsense/etasF4_06_01_01/color";
std::string calib = "/home/davidz/work/ros/indigo/src/vslam_node/dso/param/R200.txt";  // ""
double rescale = 1;
bool reverse = false;
bool disableROS = false;
int start=0;
int end=200; // 200 100000
bool prefetch = false;
...
int mode=1; // 1, without photometric calibration, 0 with photometric calibration, 2 perfect image data
